...
const startBuilding = () => {
  router.push("/portfolio-builder/profile-setup");
};
    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content">
          <h1 class="hero-title">
            Create Your Professional Freelancer Portfolio
          </h1>
          <p class="hero-subtitle">
            Build an impressive online presence in minutes with our easy-to-use
            portfolio builder
          </p>
